...
struct Pendulum {
    ...
    m: f32, // The mass of the pendulum.
    g: f32, // The gravity.
}
...
impl Pendulum {
    ...
    fn update(&mut self) {
        //  use the equation to calculate the angular  accelaration
        self.angular_acceleration = -1.0 * self.g * self.angle.sin() / self.r;
        // Angular velocity is the angular velocity plus the angular accelaration
        self.angular_velocity += self.angular_acceleration;
        // Angle plus the angular velocity
